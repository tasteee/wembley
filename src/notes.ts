import type { NotesDesignerT, ConfigT, InstanceTrackerT } from './types.js'
...
export const createNotes = (args: {
	notes: string[]
	synth: AudioSynthT
	config: ConfigT
	instanceTracker: InstanceTrackerT
}) => {
	...
	const notesInstance: NotesDesignerT = {
		...
		play: () => {
			...
			// TODO: build the notes with the given settings.
			// TODO: create a new NoteInstanceMap(notes)
			// return the NoteInstanceMap
		},
