import type { ChordDesignerT, ConfigT, VoicingT, InstanceTrackerT } from './types.js'
...
export const createChord = (args: {
	...
	const chordInstance: ChordDesignerT = {
